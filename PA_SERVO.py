...
class Servos:
    #def __init__(self, i2c, address=0x40, freq=50, min_us=500, max_us=2500,degrees=180):     #低性能舵机参数
    def __init__(self, i2c, address=0x40, freq=333, min_us=500, max_us=2500,degrees=300):     #高性能舵机参数
